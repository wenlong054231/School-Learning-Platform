...
<body>
    ...
    $sql = "SELECT * FROM user WHERE sName = '$username'";
		...
		<li><a href="ContactUs.php">Contact Us</a></li>
			<?php 		 
				 ...
				 <li style="background-color:orange">
		  			<a href="#0">Profile</a>
		  			<ul>
		    			<li style="background-color:orange"><a href="userEdit.php">Account</a></li>
		    			 <?php
    ...
    <div class="update">
    	<form action="profileUpdate.php" method="post">
			...
			<label>Email: </label>
			<input type="email" name="txtEmail" id="txtEmail" pattern="^[a-zA-Z](?!.*[^a-zA-Z0-9_@.])(?!(.*[@]){2,})(?!(.*[.]){2,})(?!(.*[_]){2,})(?=(.*[0-9]){0,})(?=(.*[A-Z]){0,}).{4,18}[a-zA-Z0-9]@gmail.com" value="<?php echo $email; ?>"/>
			<br><br>
